...
public class TestCartPage {
    ...
    public void TestApp() throws MalformedURLException {
        ...
        el5.click();
        var el6 = driver.findElement(AppiumBy.androidUIAutomator("new UiSelector().text(\"Air Jordan 1 Mid SE\")"));
        el6.click();
        var el7 = driver.findElement(AppiumBy.androidUIAutomator("new UiSelector().resourceId(\"com.androidsample.generalstore:id/productAddCart\").instance(1)"));
        el7.click();
    ...
    public void CartTest() {
        var el1 = driver.findElement(AppiumBy.id("com.androidsample.generalstore:id/appbar_btn_cart"));
        el1.click();
        var el2 = driver.findElement(AppiumBy.className("android.widget.Button"));
        el2.click();
